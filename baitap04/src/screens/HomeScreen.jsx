...
import { fetchCategories, fetchProducts, fetchUserProfile } from "../api";
...
const HomeScreen = ({ route, navigation }) => {
  ...
  const ListHeader = useMemo(
    () => (
      <>
        ...
        <View style={styles.slideShowContainer}>
          <Text style={styles.slideShowText}>Khuyến mãi Hot</Text>
        </View>
    ...
    [categories, bestSelling, userProfile, navigation]
  );

  // Memoize the LazyLoadingList render function
  const renderLazyList = useCallback(
    () => <LazyLoadingList fetchMore={fetchProducts} />,
    []
  );
